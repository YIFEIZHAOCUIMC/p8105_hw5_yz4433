...
list1 = list(rej_fun(t1), rej_fun(t2), rej_fun(t3), rej_fun(t4), rej_fun(t5), rej_fun(t6))
...
```{r}
list2 = list(mean(array(unlist(t1[[1]]))), mean(array(unlist(t2[[1]]))), mean(array(unlist(t3[[1]]))), mean(array(unlist(t4[[1]]))), mean(array(unlist(t5[[1]]))), mean(array(unlist(t6[[1]]))))
plot(list0, list2, type = "b", pch = 19, 
     col = "red", xlab = "true value", ylab = "estimate value", main = 'average estimate plot')
```